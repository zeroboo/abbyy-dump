 ...
 *       &lt;sequence>
 *         &lt;element name="Page" type="{http://www.loc.gov/standards/alto/ns-v3#}PageType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
@XmlType(name = "LayoutType", namespace = "http://www.loc.gov/standards/alto/ns-v3#", propOrder = {
    "page"
})
public class LayoutType {

    @XmlElement(name = "Page", namespace = "http://www.loc.gov/standards/alto/ns-v3#", required = true)
