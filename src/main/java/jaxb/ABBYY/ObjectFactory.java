 ...
 * generated in the ABBYY package. 
...
public class ObjectFactory {
    ...
    private final static QName _Alto_QNAME = new QName("http://www.loc.gov/standards/alto/ns-v3#", "alto");
    private final static QName _TagsTypeOtherTag_QNAME = new QName("http://www.loc.gov/standards/alto/ns-v3#", "OtherTag");
    private final static QName _TagsTypeLayoutTag_QNAME = new QName("http://www.loc.gov/standards/alto/ns-v3#", "LayoutTag");
    private final static QName _TagsTypeNamedEntityTag_QNAME = new QName("http://www.loc.gov/standards/alto/ns-v3#", "NamedEntityTag");
    private final static QName _TagsTypeRoleTag_QNAME = new QName("http://www.loc.gov/standards/alto/ns-v3#", "RoleTag");
    private final static QName _TagsTypeStructureTag_QNAME = new QName("http://www.loc.gov/standards/alto/ns-v3#", "StructureTag");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ABBYY
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.loc.gov/standards/alto/ns-v3#", name = "alto")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.loc.gov/standards/alto/ns-v3#", name = "OtherTag", scope = TagsType.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.loc.gov/standards/alto/ns-v3#", name = "LayoutTag", scope = TagsType.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.loc.gov/standards/alto/ns-v3#", name = "NamedEntityTag", scope = TagsType.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.loc.gov/standards/alto/ns-v3#", name = "RoleTag", scope = TagsType.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.loc.gov/standards/alto/ns-v3#", name = "StructureTag", scope = TagsType.class)
