 ...
 *           &lt;element name="LayoutTag" type="{http://www.loc.gov/standards/alto/ns-v3#}TagType"/>
 *           &lt;element name="StructureTag" type="{http://www.loc.gov/standards/alto/ns-v3#}TagType"/>
 *           &lt;element name="RoleTag" type="{http://www.loc.gov/standards/alto/ns-v3#}TagType"/>
 *           &lt;element name="NamedEntityTag" type="{http://www.loc.gov/standards/alto/ns-v3#}TagType"/>
 *           &lt;element name="OtherTag" type="{http://www.loc.gov/standards/alto/ns-v3#}TagType"/>
 *         &lt;/choice>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
...
@XmlType(name = "TagsType", namespace = "http://www.loc.gov/standards/alto/ns-v3#", propOrder = {
    "layoutTagOrStructureTagOrRoleTag"
})
public class TagsType {

    @XmlElementRefs({
        @XmlElementRef(name = "StructureTag", namespace = "http://www.loc.gov/standards/alto/ns-v3#", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "LayoutTag", namespace = "http://www.loc.gov/standards/alto/ns-v3#", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "RoleTag", namespace = "http://www.loc.gov/standards/alto/ns-v3#", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "NamedEntityTag", namespace = "http://www.loc.gov/standards/alto/ns-v3#", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "OtherTag", namespace = "http://www.loc.gov/standards/alto/ns-v3#", type = JAXBElement.class, required = false)
    })
